...
- `AGENTS.md` — Build commands, lint rules, headless/devkit debugging guide
- `.opencode/skills/review/` — Pre-submission review checklist
- `.opencode/skills/gnome-shell-debug/` — Looking Glass, GDB, nested sessions
